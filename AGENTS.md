...
- 维护、扩展、验收或排查“版本监控”、Windows 计划任务、独立 Runner 或 M3 报告时，先读取 `docs/M3-VERSION-MONITORING-HANDBOOK.md`；涉及产品语义变化时再读取 `docs/M3-VERSION-MONITORING-PRD.md`，涉及历史架构决策或阶段门禁时再读取 `docs/M3-VERSION-MONITORING-IMPLEMENTATION.md`。
