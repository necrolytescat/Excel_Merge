...
- 维护“表格计划对比”M4、DiffPlan 计划、TABLE 表格选择、多目标分支运行或矩阵结果时，先读取 `docs/M4-DIFF-PLAN-HANDBOOK.md`；涉及产品语义时再读取 `docs/M4-DIFF-PLAN-PRD.md` 和 `docs/adr/ADR-009-m4-diff-plan-layering.md`。
- 数据契约以 `docs/contracts/`、`docs/adr/ADR-006-m1-head-freeze-table-excel.md`、`docs/adr/ADR-007-m2-table-tablecsv-pairing.md` 和 `docs/adr/ADR-008-m2-historical-revision-endpoints.md` 为准；分支提交分页接口另见 `docs/contracts/m2.svn-branch-log.v1.md`。
